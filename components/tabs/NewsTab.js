...
export function NewsTab({ stock }) {
  ...
  const newsItems = [
    {
      ...
      sentiment: "positive",
      summary:
        "Company reported 15% increase in revenue with improved margins across all business segments.",
      url: "#",
      category: "Earnings",
    },
    {
      ...
      sentiment: "positive",
      summary:
        "New partnership expected to drive growth in emerging markets and increase market share.",
      url: "#",
    ...
    },
    {
      id: "3",
      headline:
        "Chemical Sector Faces Regulatory Headwinds in New Environmental Policy",
      source: "Dawn Business",
      publishedAt: "1 day ago",
      sentiment: "negative",
      summary:
        "New environmental regulations may impact operational costs for chemical manufacturers.",
      url: "#",
    ...
    },
    {
      ...
      sentiment: "positive",
      summary:
        "Investment focused on sustainable production methods and renewable energy initiatives.",
      url: "#",
    ...
    },
    {
      id: "5",
      headline:
        "PKR Volatility Creates Mixed Outlook for Export-Oriented Companies",
      source: "ProPakistani",
      publishedAt: "3 days ago",
      sentiment: "neutral",
      summary:
        "Currency fluctuations present both opportunities and challenges for exporters.",
      url: "#",
  ...
  const sentimentCounts = {
    positive: filteredNews.filter((item) => item.sentiment === "positive")
      .length,
    negative: filteredNews.filter((item) => item.sentiment === "negative")
      .length,
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center space-x-2">
                ...
                <span>
                  Strong earnings performance driving positive sentiment
                </span>
              </li>
              <li className="flex items-center space-x-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>
                  Regulatory environment creating sector-wide concerns
                </span>
              </li>
              <li className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            ...
            <div className="pt-3 border-t">
              <p className="text-sm text-muted-foreground">
                Overall news sentiment remains positive with 60% of coverage
                highlighting company strengths and growth opportunities. Monitor
                regulatory developments for potential sector impact.
              </p>
            </div>
          </div>
        </CardContent>
